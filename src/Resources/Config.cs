...
public static class Config
{
    ...
    public static readonly float LINE_COST = 250, POUND_COST = 1000,
    ...
    public static readonly float[] RANKS = { 1000, 2500, 10000, 20000 }; // Also set in Guild.cs

    public static readonly ulong SPONSORED_ROLE_ID = 292687552710705162, RUSH_SERVER_ID = 290759415362224139;

    public static readonly ulong[] OWNER_IDS = { 290820869964431360, 188880365522255873, 96004765233709056 }, BLACKLISTED_IDS = { 268140051081199618 },
