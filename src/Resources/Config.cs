...
public static class Config
{
    ...
    public static string GAME_STRING = "Use $help!";
    ...
    public static readonly double LINE_COST = 250.0, POUND_COST = 1000.0, KILO_COST = 2500.0, POUND_MULTIPLIER = 2.0, KILO_MULTIPLIER = 4.0, 
        ...
        MAX_STEAL = 500.0, MIN_STEAL = 250.0, STEAL_FINE = 1000.0, MAX_RESOURCES = 1000.0, MIN_RESOURCES = 25.0, DONATE_MIN = 5.0, BET_MIN = 5.0, 
        GANG_CREATION_COST = 2500.0, GANG_NAME_CHANGE_COST = 500.0, WITHDRAW_CAP = 0.20, MIN_WITHDRAW = 50.0, MIN_DEPOSIT = 25.0, 
        DEFAULT_MESSAGE_COOLDOWN = TimeSpan.FromSeconds(30).TotalMilliseconds;
