...
public static class Config
{
    ...
    public static readonly int MIN_CHAR_LENGTH = 7, LEADERBOARD_CAP = 10, RATELB_CAP = 10, WHORE_ODDS = 90, JUMP_ODDS = 85, STEAL_ODDS = 80,
        ...
        (int)TimeSpan.FromHours(1).TotalSeconds, INTEREST_RATE_COOLDOWN = (int)TimeSpan.FromHours(1).TotalSeconds,
        AUTO_UNMUTE_COOLDOWN = (int)TimeSpan.FromMinutes(5).TotalSeconds;
