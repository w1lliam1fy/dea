...
namespace DEA
{
    public static class PrettyConsole
    {
        ...
        {
            PrettyConsole.NewLine($"{DateTime.UtcNow.ToString("hh:mm:ss")} ", ConsoleColor.DarkGray);
        ...
        public static void Log(IUserMessage msg)
        {
            ...
            PrettyConsole.NewLine($"{DateTime.UtcNow.ToString("hh:mm:ss")} ", ConsoleColor.Gray);
