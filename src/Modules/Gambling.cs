...
namespace DEA.Modules
{
    public class Gambling : DEAModule
    {
        ...
        {
            return GambleAsync(bet, 20.84m, 0.2m);
        }
        ...
        {
            return GambleAsync(bet, 50.0m, 1.0m);
        }
        ...
        {
            return GambleAsync(bet, 52.5m, 1.0m);
        }
