...
namespace DEA.Modules.Crime
{
    public partial class Crime
    {
        ...
        public async Task Shoot(IGuildUser userToShoot)
        {
            ...
            {
                var userDM = await userToShoot.CreateDMChannelAsync();
                ...
                {
                    await userDM.SendAsync($"{Context.User} tried to kill you, but nigga you dodged that shit ez pz. -{damage} health. Current Health: {dbUser.Health}");
